...
public class ProducerAireMadrid1 extends ProducerClass{
    ...
    public ProducerAireMadrid1 (List<String> topic){
        this.topic=topic;
        _pause=false;
        _run=true;
...
;
                    info.put("nameProducer", "ProducerAireMadrid1");
                    valores = estaciones.get(estacion);
                    if(valores.has("08"))
                    info.put("1: Dioxido de Nitrogeno", valores.get("08"));
                    else
                        info.put("1: Dioxido de Nitrogeno", "data not found");
