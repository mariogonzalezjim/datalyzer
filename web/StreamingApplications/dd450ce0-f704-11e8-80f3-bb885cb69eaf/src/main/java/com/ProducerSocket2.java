...
public class ProducerSocket2 extends ProducerClass{
    ...
    public ProducerSocket2 (List<String> topic) throws IOException {
        this.topic=topic;
        _pause=false;
        _run=true;
        port=3334;
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            while ( (data = in.readLine()) != null ) {
                                ...
                                info.put("nameProducer", "ProducerSocket2");
                                jsonChild= json;
                                info.put("SEGUNDO: Timestamp", jsonChild.get("time"));
                                jsonChild= json;
                                info.put("SEGUNDO: Total Vehiculos Tunel", jsonChild.get("totalCochesTunel"));
