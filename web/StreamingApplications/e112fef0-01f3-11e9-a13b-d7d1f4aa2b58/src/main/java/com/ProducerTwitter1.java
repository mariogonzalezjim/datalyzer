...
public class ProducerTwitter1 extends ProducerClass{ 
    ...
    public ProducerTwitter1(List<String> topic) {
        this.topic = topic;
        _run=true;
    }
    @Override
        ...
        twitterStream.addListener(new StatusListener () {
            ...
            public void onStatus(Status status) {
                ...
                try {
                    ...
                    info.put("nameProducer", "ProducerTwitter1");
                    info.put("1: Tweet", status.getText()); 
                    info.put("1: Date", status.getCreatedAt().toString()); 
                    info.put("1: Name User", status.getUser().getName()); 
