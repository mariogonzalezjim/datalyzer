...
public class ProducerTwitter13 extends ProducerClass{ 
    ...
    public ProducerTwitter13(List<String> topic) {
        this.topic = topic;
        _run=true;
    }
    @Override
        ...
        twitterStream.addListener(new StatusListener () {
            ...
            public void onStatus(Status status) {
                ...
                try {
                    ...
                    info.put("nameProducer", "ProducerTwitter13");
                    info.put("2: Tweet", status.getText()); 
